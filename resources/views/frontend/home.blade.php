         ...
         <div class="swiper heroSwiper">
             <div class="swiper-wrapper">
                 <div class="swiper-slide">
                     <img src="https://aidandockery.com/wp-content/uploads/2023/03/siem-reap-cambodia-wedding-shoot.jpg"
                         style="">
                     {{-- <h1 class="caption">Discover Authentic</h1> --}}
                     <h1 class="caption_1">Indochina</h1>
                     <div class="discription">Founded in the 1990s, Apsara Tours has established itself as a leading tour
                         company in the ASEAN region. With an unwavering commitment to service excellence and meticulous
                         attention to detail, we have garnered rave reviews from countless satisfied customers.</div>
                 </div>
                 <div class="swiper-slide">
                     <img src="https://miro.medium.com/v2/resize:fit:1358/0*FOCbCweJXBfgu6Hg.jpeg">
                     {{-- <div class="caption">Discover Authentic 2</div> --}}
                     <div class="caption_1">Indochina</div>
                     <div class="discription">Founded in the 1990s, Apsara Tours has established itself as a leading tour
                         company in the ASEAN region. With an unwavering commitment to service excellence and meticulous
                         attention to detail, we have garnered rave reviews from countless satisfied customers.</div>
                 </div>
                 <div class="swiper-slide">
                     <img src="https://i.pinimg.com/736x/a0/9c/12/a09c127ff51fa9e14668d2ec2d7d909c.jpg">
                     {{-- <h1 class="caption">Discover Authentic 3</h1> --}}
                     <div class="caption_1S">Indochina</div>
                     <p class="discription">Founded in the 1990s, Apsara Tours has established itself as a leading tour
                         company in the ASEAN region. With an unwavering commitment to service excellence and meticulous
                         attention to detail, we have garnered rave reviews from countless satisfied customers.</p>
                 </div>
             </div>
         ...
         <div class="container">
             <div class="row">
                 ...
                 <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-0">
                     <div class="member-block">
                         <div class="member-block-image-wrap">
                             <img src="{{ asset('fornt-assets/images/members/portrait-young-handsome-businessman-wearing-suit-standing-with-crossed-arms-with-isolated-studio-white-background.jpg') }}"
                 ...
                 <div class="col-lg-3 col-md-6 col-12">
                     <div class="member-block">
                         <div class="member-block-image-wrap">
                             <img src="{{ asset('fornt-assets/images/members/successful-asian-lady-boss-red-blazer-holding-clipboard-with-documens-pen-working-looking-happy-white-background.jpg') }}"
                                 class="member-block-image img-fluid" alt="">
 ...
 @push('scripts')
     <script>
         const swiper = new Swiper('.heroSwiper', {
             ...
             effect: 'fade', // fade | slide | coverflow | creative
             fadeEffect: {
                 crossFade: true,
             },
